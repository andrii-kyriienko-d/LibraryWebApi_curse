...
namespace LibraryWebApi.Repositories
{
        ...
        where T : class, IEntityId, IEntityDateInfo
    {
        ...
        public int Create(T entity)
        {
            ...
            entity.CreatedDate = DateTime.SpecifyKind(
                        DateTime.Now.ToUniversalTime(),
                        DateTimeKind.Utc
                    );
            entity.ModifiedDate = DateTime.SpecifyKind(
                       DateTime.Now.ToUniversalTime(),
                       DateTimeKind.Utc
                   );
            try
        ...
        private int GetLastId(QueryFactory db, string tableName)
        {
            var records = db.Query(tableName)
                    ...
                    .Get<object>().ToList();
            return records.Any() ? records.Max(item => (item as IEntityId).Id) : default;
        }
        ...
        public void Update(T entity)
        {
            ...
            entity.CreatedDate = new DateTime(Get(entity.Id).CreatedDate.Ticks);
        ...
        public IEnumerable<T> Find(SearchModel findExpression)
        {
            ...
            var connectionType =
                (DbTypeAttribute)Attribute.GetCustomAttribute(typeof(IDbContext), typeof(DbTypeAttribute));
